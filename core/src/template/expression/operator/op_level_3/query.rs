...
impl<'a> Expand<Values, VariableList<'a>> for Query<'a> {
...
impl<'a> Expand<Value, VarSpec<'a>> for Query<'a> {
...
impl<'a> Expand<String, VarSpec<'a>> for Query<'a> {
...
impl<'a> Expand<Vec<String>, VarSpec<'a>> for Query<'a> {
...
impl<'a> Expand<IndexMap<String, String>, VarSpec<'a>> for Query<'a> {
